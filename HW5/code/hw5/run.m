...
outputDir = './image2/';
nFrames = 3000;
resize = [360 640];           % resize the input frame to this size. If input frame size is too large, rendering time might be very slow (MATLAB interp2 is too slow)
% -------TRACK-------
...
tic;
bundled.render(outputDir, OutputPadding,Retraction);
toc;
